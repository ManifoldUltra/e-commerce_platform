...
public class Sku {
    ...
    public String getOwnSpec() { return ownSpec; }
    public void setOwnSpec(String ownSpec) { this.ownSpec = ownSpec; }
    ...
    public String toString() {
        return "Sku [id=" + id + ", spuId=" + spuId + ", title=" + title +
                ", images=" + images + ", price=" + price + ", indexes=" + indexes +
                ", ownSpec=" + ownSpec + ", enable=" + enable + ", createTime=" + createTime +
